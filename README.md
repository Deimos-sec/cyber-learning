...
Mi objetivo es convertirme en Analista de Ciberseguridad Junior en menos de 1 año, combinando cursos, practica y proyectos reales.
...
- Cisco - Introduction to Cibersecurity
  ...
  - Phython para ciberseguridad
    ...
    ## Laboratorios y Write-ups
    (Proximamente subire mis primeras maquinas de TryHackMy aqui)
   ...
   ## Scripts en Python
    ...
    ## Objetivo 2026
  Conseguir mi primer trabajo en ciberseguridad como SOC Analyst L1, Cybersegurity Intern o Junior Analyst.
